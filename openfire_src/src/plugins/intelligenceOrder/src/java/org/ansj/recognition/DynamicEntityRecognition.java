 ...
 * 
 */
public class DynamicEntityRecognition {

	private Term[] terms = null;

	private WoodInterface[] forests = { DynamicEntityLibrary.getForest() };
	...
	public DynamicEntityRecognition(Term[] terms, Forest... forests) {
		this.terms = terms;
